...
class KaupPage extends StatefulWidget {
  ...
  @override
  _KaupPageState createState() => _KaupPageState();
}

class _KaupPageState extends State<KaupPage> with TickerProviderStateMixin {
  ...
  String kc="Kaup Beach is one of the major beaches in the city of Mangalore. With its tropical climate and bevy of attractions that beckon tourists from across the country, Mangaluru is a port city that promises to keep uplifting your spirits every minute you spend in this city.";
  @override
              ...
              color: Color(0XFFA1CCF3),
                ...
                onPressed: () {
                  launchMap({String lat = "13.347317", String long = "74.7933167"}) async{
                    ...
                    String url='https://www.google.com/maps/place/Kapu+Light+House/@13.2239492,74.6667596,12z/data=!4m8!1m2!2m1!1skapu+beach!3m4!1s0x3bbcb0568b04f2db:0x7a54289d4ad83a6d!8m2!3d13.2239492!4d74.7367974';
            ...
            RaisedButton(
              ...
              color: Color(0XFFA1CCF3),
                ...
                onPressed: () {
                  launchMap({String lat = "13.347317", String long = "74.7933167"}) async{
                    var mapSchema = 'geo:$lat,$long';
                    String url='https://www.google.com/maps/search/Restaurants/@13.2098568,74.7310683,14z/data=!3m1!4b1!4m8!2m7!3m6!1sRestaurants!2sKapu+Light+House,+Padu,+Karnataka+574106!3s0x3bbcb0568b04f2db:0x7a54289d4ad83a6d!4m2!1d74.7367974!2d13.2239492';
                    if (await canLaunch(url)) {
                      await launch(url);
                    } else {
                      throw 'Could not launch $mapSchema';
            ...
            RaisedButton(
              ...
              color: Color(0XFFA1CCF3),
                ...
                onPressed: () {
                  launchMap({String lat = "13.347317", String long = "74.7933167"}) async{
                    var mapSchema = 'geo:$lat,$long';
                    String url='https://www.google.com/maps/search/Hotels/@13.2239301,74.6667593,12z/data=!3m1!4b1!4m8!2m7!3m6!1sHotels!2sKapu+Light+House,+Padu,+Karnataka+574106!3s0x3bbcb0568b04f2db:0x7a54289d4ad83a6d!4m2!1d74.7367974!2d13.2239492';
                    if (await canLaunch(url)) {
                      await launch(url);
                    } else {
                      throw 'Could not launch $mapSchema';
  ...
  Container _backBgCover() {
    int _currentIndex=0;
    List welcomeImages=[
    listItem('images/Kaup_beach.jpg'),
    listItem('images/Kaup_beach_1.jpg'),
