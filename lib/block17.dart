...
class _BlockPageState extends State<BlockPage> with TickerProviderStateMixin {
  ...
  String kc="Very nice cozy living space for aspiring engineers at MIT, the single AC rooms are excellent. In every Hostel Block there is a dedicated laundry and cleaning service. Hot water is available for a shower every morning. Block 17 is placed 1.2 km from the food court which makes it one of the closest blocks to the food court. Overall living experience here is great.";
  @override
  ...
  Container _backBgCover() {
    int _currentIndex=0;
    List welcomeImages=[
    listItem('images/block17_view_2.jpeg'),
    listItem('images/block_17_view_3.jpeg'),
    listItem('images/hostel_block_17_view.jpeg')
  ];
