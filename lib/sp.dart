...
class _SPPageState extends State<SPPage> with TickerProviderStateMixin {
  ...
  String kc="One of the important landmarks of Manipal University is Student Plaza.It is not just a place for MITians, they have an emotional connect with it. A great place to sit and relax after a long day at campus. The crowd gatherings are lively along with their shopping and dining outlets.";
  @override
  ...
  Container _backBgCover() {
    int _currentIndex=0;
    List welcomeImages=[
    listItem('images/StudentPlaza.JPG'),
    listItem('images/StudentPlaza2.jpeg'),
  ];
